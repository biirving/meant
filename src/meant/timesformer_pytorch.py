...
class TimeSformer(nn.Module):
    ...
    def meant_forward(self, video, mask = None):
        ...
        # Lets see what happens when we just process without the class token?
        # Just use the spatio temporal attention mechanism to process the image sequence
        #cls_token = x[:, 0]
        return x
