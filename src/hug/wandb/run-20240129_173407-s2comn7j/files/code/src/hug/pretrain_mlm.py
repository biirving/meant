...
if __name__=='__main__':
    ...
    parser.add_argument('-b', '--batch_size',type=int, help='Batch size for pretraining', default=32)
    ...
    # Our dataset to pass to our Dataset object
    ...
    # then delete the data to clear space
    del data
    gc.collect()
